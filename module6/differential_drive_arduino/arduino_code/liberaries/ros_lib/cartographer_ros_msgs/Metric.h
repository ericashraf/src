...
namespace cartographer_ros_msgs
{
  ...
  class Metric : public ros::Msg
  {
    ...
    Metric():
      ...
      value(0),
      counts_by_bucket_length(0), counts_by_bucket(NULL)
    {
    }
    ...
    const char * getType(){ return "cartographer_ros_msgs/Metric"; };
    const char * getMD5(){ return "94a6ea1c6ef245b483a220f6769c8e36"; };
