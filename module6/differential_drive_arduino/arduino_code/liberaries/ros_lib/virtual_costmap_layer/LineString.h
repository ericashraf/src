#ifndef _ROS_virtual_costmap_layer_LineString_h
#define _ROS_virtual_costmap_layer_LineString_h
...
namespace virtual_costmap_layer
{
  ...
  class LineString : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "virtual_costmap_layer/LineString"; };
