#ifndef _ROS_virtual_costmap_layer_Ring_h
#define _ROS_virtual_costmap_layer_Ring_h
...
namespace virtual_costmap_layer
{
  ...
  class Ring : public ros::Msg
  {
    ...
    const char * getType(){ return "virtual_costmap_layer/Ring"; };
